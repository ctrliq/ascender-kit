...
class Resources:
    ...
    _application_tokens = r'applications/\d+/tokens/'
    _auth = 'auth/'
    _bulk = 'bulk/'
    ...
    _execution_environment_unified_job_templates = r'execution_environments/\d+/unified_job_templates/'
    _group = r'groups/\d+/'
    ...
    _host_metric_summary_monthly = 'host_metric_summary_monthly/'
    _host_related_ad_hoc_commands = r'hosts/\d+/ad_hoc_commands/'
    _host_related_ad_hoc_command_events = r'hosts/\d+/ad_hoc_command_events/'
    _host_related_all_groups = r'hosts/\d+/all_groups/'
    _host_related_job_events = r'hosts/\d+/job_events/'
    _host_related_job_host_summaries = r'hosts/\d+/job_host_summaries/'
    _host_related_smart_inventories = r'hosts/\d+/smart_inventories/'
    ...
    _inventory_input_inventories = r'inventories/\d+/input_inventories/'
    ...
    _workflow_approval_related_votes = r'workflow_approvals/\d+/votes/'
    _workflow_approval_template_approvals = r'workflow_approval_templates/\d+/approvals/'
    _workflow_approval_vote = r'workflow_approval_votes/\d+/'
    _workflow_approval_votes = 'workflow_approval_votes/'
    ...
    _job_template_notification_templates_changed = r'job_templates/\d+/notification_templates_changed/'
    ...
    _organization_notification_templates_changed = r'organizations/\d+/notification_templates_changed/'
    ...
    _receptor_address = r'receptor_addresses/\d+/'
    _receptor_addresses = 'receptor_addresses/'
    ...
    _service_index_resource = r'service-index/resources/[0-9a-f-]+/'
    _service_index_resource_type = r'service-index/resource-types/[^/]+/'
    _service_index_resource_types = 'service-index/resource-types/'
    _service_index_resources = 'service-index/resources/'
    ...
    _role = r'roles/\d+/'
    _roles = 'roles/'
    _role_children = r'roles/\d+/children/'
    _role_parents = r'roles/\d+/parents/'
    _roles_related_teams = r'roles/\d+/teams/'
    _schedule = r'schedules/\d+/'
    _schedules = 'schedules/'
    _schedules_jobs = r'schedules/\d+/jobs/'
    _schedule_labels = r'schedules/\d+/labels/'
    ...
    _user_applications = r'users/\d+/applications/'
    _user_authorized_tokens = r'users/\d+/authorized_tokens/'
    _user_personal_tokens = r'users/\d+/personal_tokens/'
    _user_tokens = r'users/\d+/tokens/'
    ...
    _workflow_job_node_labels = r'workflow_job_nodes/\d+/labels/'
    _workflow_job_node_condition_nodes = r'workflow_job_nodes/\d+/condition_nodes/'
    ...
    _workflow_job_template_access_list = r'workflow_job_templates/\d+/access_list/'
    ...
    _workflow_job_template_node_labels = r'workflow_job_template_nodes/\d+/labels/'
    _workflow_job_template_node_condition_nodes = r'workflow_job_template_nodes/\d+/condition_nodes/'
