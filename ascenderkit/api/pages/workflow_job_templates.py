...
from ascenderkit.api.mixins import HasCreate, HasNotifications, HasSurvey, HasCopy, DSAdapter
from ascenderkit.api.pages import Organization, UnifiedJobTemplate
from ascenderkit.utils import filter_by_class, not_provided, update_payload, random_title, PseudoNamespace
...
class WorkflowJobTemplate(HasCopy, HasCreate, HasNotifications, HasSurvey, UnifiedJobTemplate):
    ...
    def launch(self, payload=None):
        ...
        if jobs_pg.count != 1:
            ...
            raise exc.UnexpectedAscenderState(msg)
