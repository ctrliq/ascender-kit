from ascenderkit.api.mixins import HasCreate, DSAdapter
from ascenderkit.utils import random_title, PseudoNamespace
...
class User(HasCreate, base.Base):
    ...
    def payload(self, **kwargs):
        payload = PseudoNamespace(
            username=kwargs.get('username') or f'User-{random_title(non_ascii=False)}',
            ...
            email=kwargs.get('email', f'{random_title(5, non_ascii=False)}@example.com'),
        )
        return payload
